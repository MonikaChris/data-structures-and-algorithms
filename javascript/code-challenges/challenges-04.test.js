...
This function should first create a new array. Then iterate over the input array and modify each value based
on the callback function provided.
...
const updateAnimal = (arr, callback) => {
  const animals = [];
  arr.forEach(animal => animals.push(callback(animal)));
  return animals;
};
...
const sortPeopleBetter = (arr) => {
  return arr.sort((a, b) => {
    const last1 = a.lastName.toUpperCase();
    const last2 = b.lastName.toUpperCase();
    const first1 = a.firstName.toUpperCase();
    const first2 = b.firstName.toUpperCase();
    const age1 = a.age;
    const age2 = b.age;
